 ...
 */
public class TopPerformingReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        topProductTbl = new javax.swing.JTable();
        ...
        topProductTbl.setFont(new java.awt.Font("Poppins SemiBold", 1, 13)); // NOI18N
        topProductTbl.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null},
                {null, null, null},
                {null, null, null},
        ...
        jScrollPane1.setViewportView(topProductTbl);
        ...
        iconLbl.setIcon(new javax.swing.ImageIcon("C:\\ShopManagementSystem\\src\\main\\java\\com\\zx\\shopmanagementsystem\\images\\TopPerformingProductReport.png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TopPerformingReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable topProductTbl;
        ...
        try {
            ...
            if (rs2.next()) {
                while (rs.next()) {
                    ...
                    DefaultTableModel table = (DefaultTableModel) topProductTbl.getModel();
    ...
    private void tableDataClear() {
        try {
            while (0 <= topProductTbl.getRowCount()) {
                DefaultTableModel table = (DefaultTableModel) topProductTbl.getModel();
                table.removeRow(topProductTbl.getRowCount() - 1);
            }
        } catch (Exception e) {
    ...
    private void generateExcelReport() {
        ...
        String fileName = "Top Performing_Report _" + fromDateTxt.getText() + "_to_" + toDateTxt.getText() + ".xlsx";
        String directoryPath = System.getProperty("user.home") + File.separator + "Documents\\Reports\\Excel\\Top-Performing";
        ...
        ExcelExporterProduct.exportToExcel(topProductTbl, filePath);
    }

    private void generatePdfReport() {
        // Create file path using File.separator for cross-platform compatibility
        String fileName = "Top Performing_Report _" + fromDateTxt.getText() + "_to_" + toDateTxt.getText() + ".pdf";
        String directoryPath = System.getProperty("user.home") + File.separator + "Documents\\Reports\\PDF\\Top-Performing";
        String filePath = directoryPath + File.separator + fileName;
        ...
        // Generate the Excel report
        PdfExporterProduct.exportToPdf(topProductTbl, filePath);
    }
}
