 ...
 * @author User
 */
public class DashboardAdminBackup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menu1.add(imageAvatar, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 50, 170, 160));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DashboardAdminBackup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new DashboardAdminBackup().setVisible(true);
            }
        });
    }
