...
public class ProfitReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        salesTbl.setFont(new java.awt.Font("Poppins SemiBold", 1, 13)); // NOI18N
        salesTbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sales Date", "Product Name", "Product Sold", "Total Profit"
            }
        ) {
        ...
        iconLbl.setIcon(new javax.swing.ImageIcon("C:\\ShopManagementSystem\\src\\main\\java\\com\\zx\\shopmanagementsystem\\images\\ProfitReport.png")); // NOI18N
    ...
    private void tableDataLoader() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String total_sales = (rs.getString("total_profit"));
            ...
            System.out.println("Profit Report Table Data Loader : " + ex);
        }
    }
    ...
    private void tableDataClear() {
        try {
            ...
            System.out.println("Profit Report Table Data Clear : " + e);
        }
    }
    ...
    private void generateExcelReport() {
        ...
        String fileName = "Profit_Report_" + fromDateTxt.getText() + "_to_" + toDateTxt.getText() + ".xlsx";
        String directoryPath = System.getProperty("user.home") + File.separator + "Documents\\Reports\\Excel\\Profit";
    ...
    private void generatePdfReport() {
        // Create file path using File.separator for cross-platform compatibility
        String fileName = "Profit_Report_" + fromDateTxt.getText() + "_to_" + toDateTxt.getText() + ".pdf";
        String directoryPath = System.getProperty("user.home") + File.separator + "Documents\\Reports\\PDF\\Profit";
        String filePath = directoryPath + File.separator + fileName;
