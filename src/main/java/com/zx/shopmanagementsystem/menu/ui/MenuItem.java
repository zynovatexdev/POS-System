...
import com.zx.shopmanagementsystem.menu.effect.RippleEffect;
import com.zx.shopmanagementsystem.menu.swing.shadow.ShadowRenderer;
...
public class MenuItem extends JButton {
    ...
    public void initSubMenu(int subMenuIndex, int length) {
        ...
        setBackground(Color.decode("#52157d"));
        setOpaque(true);
    }
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        if (length != 0) {
            g2.setColor(Color.decode("#52157d"));
            if (subMenuIndex == 1) {
                //  First Index
